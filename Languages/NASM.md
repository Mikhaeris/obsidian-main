...
Общая директива `%if`, в которой условие задается арифметико-логическим выражением, вычисляемым во время компиляции.

Набор допустимых операций расширяется операциями `=`, ``

...
#### CDECL
Согласно этой конвенции подпрограмма имеет право портить EAX, EDX и ECX, а все остальные регистры общего назначения должна либо не трогать, либо сохранить и перд возвратом управления восставновить.
Регистр EAX портится постоянно, поскольку многие 

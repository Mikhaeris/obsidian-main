...
Процессор поддерживает также команды «сложных» побитовых сдвигов `shrd` и `shld`, работающих через два регистра; команды циклического побитового сдвига `ror` и `rol`; команды циклического сдвига через флаг CF - `rcr` u `rcl`. Могут оказаться очень полезны команды, работающие с отдельными битами своих операндов - bt, bts, btc, btr, bsf u bsr.Ф

...
Команда loope, называемая также loopz, производит переход, если в регистре после его уменьшения на еденицу - не ноль и при этом флаг ZF устан
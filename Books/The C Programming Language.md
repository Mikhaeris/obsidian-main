...
.
	...
	7.6. Ввод-вывод строк
			Функция fgets считывает очередную строку(вместе с символом ее конца) из файла fp в массив символов line, получившаяся строка завершается ну
Продолжение - 7.6
cтраница 175

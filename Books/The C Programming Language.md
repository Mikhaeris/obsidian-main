...
.
		...
		Первый аргумент fopen - это символьная строка, содержащая имя файла. Второй аргумент - режим открытия; это также символьная строка, указывающая 
Продолжение - 7
cтраница 164

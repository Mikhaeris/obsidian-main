...
- Pешение: Проверить первое и последнее слово. Дальше искать пробелы и проверять предыдущий символ(конце предыдущего слова) и следующий символ(начало следующего слова).